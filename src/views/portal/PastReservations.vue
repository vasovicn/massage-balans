<template>
    <div class="row" style="padding:30px">
      <div class="col-8" v-if="this.$store.state.isMasseur">
        <div style="margin-top: 78px;display: flex;justify-content: center;" v-if="sortedReservations.filter(x => Date.parse(x) < Date.parse(currentDate)).length === 0">Istorija rezervacija nije dostupna</div>
