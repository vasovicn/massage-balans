<template>
    ...
    <div v-if="massageID" style="text-align: center;">
        ...
        <TimeComponent v-if="date && clicked && this.selectedProduct !== 'Odaberi trajanje'" :date="date" :massage="massage" :currentTime="currentTime"
            :masseur_id="selectedMasseur.id" :currentDate="dateMin" @clicked-time="clickedTime"
            :timePeriod="this.timePeriod" :selectedProduct="this.selectedProduct"/>
